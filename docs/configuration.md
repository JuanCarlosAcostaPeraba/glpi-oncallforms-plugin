...
Los dos formularios deben ser diferentes y permanecer activos, sin eliminar, disponibles en el ámbito de la entidad actual y accesibles para el usuario actual. La configuración es global en la versión 1.0.2; configúrela desde una entidad donde estén disponibles ambos formularios.
