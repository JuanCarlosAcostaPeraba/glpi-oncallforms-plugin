...
See [docs/configuration.md](docs/configuration.md). Version 1.0.4 stores one global configuration. The form selector shows only active, non-deleted native forms allowed by GLPI's current entity and access policies.
